    ...
    categories: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'th18', num: '18', name: 'Boeuf piquant au basilic', desc: 'Bœuf sauté au basilic thaï et piment', priceRestaurant: 16.00, priceTraiteur: 14.50 },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'th30', num: '30', name: 'Riz saute au poulet', desc: 'Riz parfumé sauté au wok avec poulet', priceRestaurant: 10.00, priceTraiteur: 10.50 },
          { id: 'th31', num: '31', name: 'Riz saute Special Mix', desc: 'Poulet, scampis, porc et légumes', priceRestaurant: 13.00, priceTraiteur: 13.00 },
          { id: 'th32', num: '32', name: 'Riz saute aux scampis', desc: 'Riz parfumé sauté au wok avec scampis', priceRestaurant: 14.00, priceTraiteur: 14.50 },
          { id: 'th33', num: '33', name: 'Vermicelles de riz aux nems', desc: 'Vermicelles garnis de nems croustillants', priceRestaurant: 10.00, priceTraiteur: null },
    ...
    categories: [
      {
        ...
        items: [
          ...
          { id: 'vn02', num: '02', name: 'Potage au poivre oriental', desc: 'Bouillon relevé aux épices orientales', priceRestaurant: 6.00, priceTraiteur: 5.50 },
          { id: 'vn2a', num: '2a', name: 'Potage aux legumes frais', desc: 'Légumes de saison en bouillon parfumé', priceRestaurant: 6.00, priceTraiteur: 5.50 },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'vn08', num: '08', name: 'Eventail de scampis croquants', desc: 'Scampis panés en éventail, dorés et croustillants', priceRestaurant: 9.00, priceTraiteur: 8.00 },
      ...
      },
      {
        ...
        items: [
          { id: 'vn10', num: '10', name: 'Bouchees de porc ou poulet', desc: 'Raviolis vapeur farcis', priceRestaurant: 6.00, priceTraiteur: 5.50 },
          { id: 'vn11', num: '11', name: 'Bouchees de langoustines', desc: 'Ou coquilles St-Jacques', priceRestaurant: 6.50, priceTraiteur: 6.00 },
          { id: 'vn12', num: '12', name: 'Assortiment de Dim Sum', desc: 'Sélection variée de bouchées vapeur', priceRestaurant: 10.00, priceTraiteur: 9.50 },
        ]
      },
      {
        id: 'viet_volailles',
        name: 'Volailles',
        items: [
          { id: 'vn13', num: '13', name: 'Poulet aux ananas frais', desc: 'Poulet sauté aux morceaux d\'ananas frais', priceRestaurant: 13.50, priceTraiteur: 12.50 },
          { id: 'vn14', num: '14', name: 'Poulet imperial piquant', desc: 'Poulet croustillant, sauce impériale pimentée', priceRestaurant: 13.50, priceTraiteur: 12.50 },
          { id: 'vn15', num: '15', name: 'Poulet aux 3 champignons', desc: 'Shiitake, pleurotes et champignons noirs', priceRestaurant: 13.50, priceTraiteur: 12.50 },
          { id: 'vn16', num: '16', name: "Canard a l'orange", desc: 'Canard rôti, sauce à l\'orange maison', priceRestaurant: 19.00, priceTraiteur: null },
      ...
      },
      {
        ...
        name: 'Porc & Boeuf',
        items: [
          { id: 'vn18', num: '18', name: 'Porc sauce aigre-douce', desc: 'Porc pané, sauce aigre-douce aux légumes', priceRestaurant: 14.00, priceTraiteur: 13.50 },
          { id: 'vn19', num: '19', name: 'Porc laque au miel', desc: 'Porc caramélisé au miel et sésame', priceRestaurant: 14.00, priceTraiteur: 13.50 },
          { id: 'vn20', num: '20', name: 'Boeuf grille facon du Chef', desc: 'Aux vermicelles', priceRestaurant: 17.00, priceTraiteur: 15.50 },
          { id: 'vn21', num: '21', name: 'Boeuf satay piquant', desc: 'Bœuf sauté sauce satay épicée aux cacahuètes', priceRestaurant: 16.00, priceTraiteur: 14.50 },
      ...
      },
      {
        ...
        name: 'Poissons & Crustaces',
        items: [
          { id: 'vn23', num: '23', name: 'Calamars croquants', desc: 'Calamars frits, dorés et croustillants', priceRestaurant: 14.00, priceTraiteur: null },
          ...
          { id: 'vn27', num: '27', name: "Cuisses de grenouilles a l'ail", desc: 'Sautées au beurre d\'ail et persil', priceRestaurant: 17.00, priceTraiteur: null },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'vn30', num: '30', name: 'Riz saute au poulet', desc: 'Riz parfumé sauté au wok avec poulet', priceRestaurant: 11.00, priceTraiteur: 10.50 },
          { id: 'vn31', num: '31', name: 'Riz saute Special Mix', desc: 'Poulet, scampis, porc et légumes', priceRestaurant: 14.00, priceTraiteur: 13.00 },
          { id: 'vn32', num: '32', name: 'Riz saute aux scampis', desc: 'Riz parfumé sauté au wok avec scampis', priceRestaurant: 15.00, priceTraiteur: 14.50 },
          { id: 'vn33', num: '33', name: 'Vermicelles de riz aux nems', desc: 'Vermicelles garnis de nems croustillants', priceRestaurant: 11.00, priceTraiteur: null },
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'vn36', num: '36', name: 'Nouilles sautees poulet', desc: 'Nouilles de blé sautées au wok avec poulet', priceRestaurant: 11.00, priceTraiteur: 10.50 },
          { id: 'vn37', num: '37', name: 'Nouilles sautees porc laque', desc: 'Nouilles sautées au porc laqué caramélisé', priceRestaurant: 13.00, priceTraiteur: 12.50 },
          { id: 'vn38', num: '38', name: 'Nouilles Facon du Chef', desc: 'Recette signature du Chef, garniture variée', priceRestaurant: 14.00, priceTraiteur: 13.50 },
          { id: 'vn39', num: '39', name: 'Nouilles sautees scampis', desc: 'Nouilles de blé sautées au wok avec scampis', priceRestaurant: 15.00, priceTraiteur: 14.50 },
          { id: 'vn40', num: '40', name: 'Grande soupe Pho au boeuf', desc: 'Tonkinoise', priceRestaurant: 13.00, priceTraiteur: null },
          { id: 'vn41', num: '41', name: 'Grande soupe Saigon', desc: 'Bouillon parfumé, scampis, viande, nouilles', priceRestaurant: 13.00, priceTraiteur: null },
        ]
      },
      {
        id: 'viet_vegetariens',
        name: 'Vegetariens',
        items: [
          { id: 'vn42', num: '42', name: 'Legumes frais sautes', desc: 'Légumes de saison sautés au wok', priceRestaurant: 11.00, priceTraiteur: 10.50 },
          ...
          { id: 'vn45', num: '45', name: 'Cassolette de legumes au curry', desc: 'Légumes mijotés au curry et lait de coco', priceRestaurant: 13.00, priceTraiteur: 12.50 },
        ]
      },
    ]
  }
...
export const featuredDishes = [
  ...
  { id: 'th04', name: 'Satay Poulet', desc: 'Brochettes de poulet grillées', price: 7.00, image: 'https://images.pexels.com/photos/19792082/pexels-photo-19792082.jpeg?auto=compress&cs=tinysrgb&w=800' },
